...
![image-20230318203631507](\root\img\image-20230318203631507.png)
...
![image-20230318162702069](\root\img\image-20230318162702069.png)
...
![img](\root\img\v2-4f597eefc3b43129ad52582862aea633_1440w.jpeg)
...
![img](\root\img\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0thaXl1YW5fc2p0dQ==,size_16,color_FFFFFF,t_70.png)
...
![\small Attention(Query, Source) = \sum_{i=1}^{L_{x}}Similarity(Query, Key_{i})* Value_{i}](\root\img\sum_{i%3D1}^{L_{x}}Similarity(Query%2C Key_{i}) Value_{i}.gif)

关于求Query和Key之间相关性的方法，文献中给出有几种：

![CGYSF{}TMD7VOP0XWH@G$0V](\root\img\CGYSF{}TMD7VOP0XWH@G$0V.png)
...
![image-20230318163257926](\root\img\image-20230318163257926-1679316386272-1.png)
...
![image-20230318163145867](\root\img\image-20230318163145867.png)
...
![image-20230318163209360](\root\img\image-20230318163209360.png)

Self-Attention 的输入用矩阵X进行表示，则可以使用线性变阵矩阵**WQ,WK,WV**计算得到**Q,K,V**。计算如下图所示，**注意 X, Q, K, V 的每一行都表示一个单词。**

得到矩阵 Q, K, V之后就可以计算出 Self-Attention 的输出了，计算的公式如下：

![image-20230318163257926](\root\img\image-20230318163257926.png)
...
![img](\root\img\v2-9caab2c9a00f6872854fb89278f13ee1_1440w.webp)

得到**QK<sup>T</sup>** 之后，使用 Softmax 计算每一个单词对于其他单词的 attention 系数，公式中的 Softmax 是对矩阵的每一行进行 Softmax，即每一行的和都变为 1。

![img](\root\img\v2-96a3716cf7f112f7beabafb59e84f418_1440w.webp)
...
![img](\root\img\v2-27822b2292cd6c38357803093bea5d0e_r.jpg)
...
![img](\root\img\v2-6bdaf739fd6b827b2087b4e151c560f4_r.jpg)
...
![img](\root\img\v2-35d78d9aa9150ae4babd0ea6aa68d113_r.jpg)
...
![img](\root\img\v2-0203e83066913b53ec6f5482be092aa1_1440w.webp)
...
![img](\root\img\v2-a4b35db50f882522ee52f61ddd411a5a_1440w.webp)
...
![img](\root\img\v2-4b3dde965124bd00f9893b05ebcaad0f_1440w.webp)
...
![img](\root\img\v2-47b39ca4cc3cd0be157d6803c8c8e0a1_1440w.webp)
...
![img](\root\img\v2-45db05405cb96248aff98ee07a565baa_1440w.webp)
...
![img](\root\img\v2-335cfa1b345bdd5cf1e212903bb9b185_1440w-1679143408882-39.webp)

Decoder Softmax 之前的 Z

Softmax 根据输出矩阵的每一行预测下一个单词：

![img](\root\img\v2-0938aa45a288b5d6bef6487efe53bd9d_1440w-1679143416785-41.webp)
